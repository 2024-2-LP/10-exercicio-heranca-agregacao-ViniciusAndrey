...
public class DesenvolvedorMobile extends Desenvolvedor {
    ...
    public DesenvolvedorMobile(String nome, Integer qtdHoras, Double valorHora, String plataforma, String linguagem, Integer horasPrototipocao) {
        super(nome, qtdHoras, valorHora);
        this.plataforma = plataforma;
        this.linguagem = linguagem;
        this.horasPrototipacao = horasPrototipocao;
    }

    @Override
    public Double calcularSalario() {
        return super.qtdHoras * super.valorHora + (horasPrototipacao * 200);
    }
